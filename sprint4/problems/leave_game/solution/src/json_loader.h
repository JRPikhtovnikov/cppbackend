...
model::Game LoadGame(const std::filesystem::path& json_path, LootTypesMap& loot_types, LootValuesMap& loot_values, double& loot_period, double& loot_probability, double& dog_retirement_time);
